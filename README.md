...
<h2 id="logging-files">5. Logging Files &amp; Data Setup</h2>
<p>
The post-hoc analysis and dynamic evaluation depend on multi-iteration RAG reasoning traces
generated by the system. You can either <strong>download the provided logs</strong> or
<strong>generate them yourself</strong>, depending on your workflow.
</p>

<h3>Option 1: Use Pre-generated Logging Files</h3>
<p>
Download the full logging dataset (R1 reasoning traces, retrieval outputs, and metadata) from the link below.
Place the extracted files inside <code>src/data/</code> or the directory specified in your configuration.
</p>

<p align="center">
  <a href="https://drive.google.com/drive/folders/1xMoYLfwLg99Q2npMi5P4zwSdTg0LR13W?usp=drive_link" target="_blank">
    Download Logging Files
  </a>
</p>

<h3>Option 2: Generate Logging Files Yourself</h3>
<p>
If you prefer to generate your own logs, run the multi-iterative RAG pipeline included in the repository:
</p>

<pre><code>python src/get_r1_res_nq-test.py
</code></pre>

<p>
This script will produce the reasoning traces consumed by
<code>post-hoc-analysis.py</code> during static and dynamic cutoff experiments.
</p>

<h2 id="installation-usage">6. Installation &amp; Code Usage</h2>
<ol> 
  <li>
